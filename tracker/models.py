...
'''
This model will allow the user to be able to set the limit that he or she would want to be notified when the value is reached.
'''


class CryptocurrencyValue (models.Model):
